      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/register"
              className="bg-gradient-to-r from-orange-600 to-orange-600 text-white px-4 py-2 rounded-lg font-medium hover:from-orange-700 hover:to-orange-700 transition-all duration-200"
            >
              Join Club
            </Link>
          </nav>
          ...
          >
            <nav className="flex flex-col space-y-4">
              ...
              <Link
                to="/register"
                onClick={() => setIsMenuOpen(false)}
                className="bg-gradient-to-r from-orange-600 to-orange-600 text-white px-4 py-2 rounded-lg font-medium hover:from-orange-700 hover:to-orange-700 transition-all duration-200 text-center"
              >
                Join Club
              </Link>
            </nav>
