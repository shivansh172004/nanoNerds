...
const Register = () => {
  ...
  try {
    // ✅ URL updated to match backend route: /api/members/register
      ...
      <div className="min-h-screen py-12">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Thank you for your interest in joining Nano-Nerds Electronics
              Club. We have received your application and will review it
              shortly.
            </p>
            <div
            ...
            >
              ...
              >
                ...
                <li>
                  • If selected, you'll be invited to an orientation session
                </li>
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            Ready to dive into the world of electronics? Fill out the form below
            to become part of our innovative community.
          </p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {interestOptions.map((interest) => (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`flex-shrink-0 w-4 h-4 rounded border mr-3 flex items-center justify-center ${
                        formData.interests.includes(interest)
            ...
            >
              ...
              >
                <li>
                  • Regular participation in club activities and meetings is
                  expected
                </li>
                <li>
                  • Members are required to maintain good academic standing
                </li>
                <li>
                  • Respect for fellow members and club property is mandatory
                </li>
                <li>• Club membership is subject to annual renewal</li>
                <li>
                  • Members may be required to contribute to club projects and
                  events
                </li>
              </ul>
              <p
              ...
              >
                By submitting this form, you agree to abide by the club's rules
                and regulations.
              </p>
            </div>
