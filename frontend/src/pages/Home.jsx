...
const Home = () => {
  ...
  const offerings = [
    {
      ...
      description:
        "Work on practical electronics projects using Arduino, microcontrollers, and core electronics concepts.",
    },
    {
      icon: Cpu,
      title: "Skill-Building Workshops",
      description:
        "Beginner-friendly workshops covering embedded systems, digital electronics, and VLSI fundamentals.",
    },
    {
      icon: Calendar,
      title: "Events & Competitions",
      description:
        "Participate in technical events, quizzes, and competitions during college fests and club activities.",
    },
    {
      icon: Users,
      title: "Collaborative Learning",
      description:
        "Learn and grow together in a supportive environment guided by peers and seniors.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section
        className={`py-24 ${
          darkMode ? "bg-blue-950" : "bg-blue-600"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6">
            Welcome to <span className="text-yellow-400">Nano-Nerds</span>
          </h1>

          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-10">
            A student-led electronics club focused on embedded systems, VLSI
            fundamentals, and hands-on learning through projects, workshops, and
            technical events.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="bg-yellow-400 text-black px-8 py-4 rounded-lg font-semibold text-lg hover:bg-yellow-300 transition"
            >
              Join Nano-Nerds
              <ArrowRight className="inline-block ml-2 h-5 w-5" />
            </Link>
      ...
      <section className={`py-20 ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            >
              Nano-Nerds provides opportunities to explore electronics beyond
              the classroom through practical learning.
            </p>
          </div>
      ...
      {/* FINAL CTA */}
      <section className={`${darkMode ? "bg-blue-950" : "bg-blue-600"} py-20`}>
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl font-bold text-white mb-4">
            Interested in Electronics and Technology?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Become a part of Nano-Nerds and start building, learning, and growing
