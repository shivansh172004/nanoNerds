...
//       year: "2025",
//       title: "kive aa singh",
//       description: "wayeguru ka khalsa wayeguru ki fateh",
//     },
//     {
//       year: "2025",
//       title: "abracadabra",
...
//       year: "2024",
//       title: "Innovation Excellence",
//       description: "5+ successful student projects completed",
//     },
//     {
//       year: "2024",
//       title: "Club Establishment",
//       description: "Founded with 15 founding members",
//     },
//   ];
...
//       title: "Innovation",
//       description:
//         "Fostering creative thinking and breakthrough solutions in electronics",
//     },
//     {
//       icon: Users,
//       title: "Collaboration",
//       description:
//         "Building strong partnerships between students, faculty, and industry",
//     },
//     {
//       icon: BookOpen,
//       title: "Learning",
...
//       title: "Technical Workshops",
//       description:
//         "Regular sessions on VLSI design, PCB development, and embedded systems",
//       frequency: "Weekly",
//     },
//     {
//       title: "Guest Lectures",
...
//       title: "Project Competitions",
//       description:
//         "Inter-college competitions to showcase innovative electronics projects",
//       frequency: "Quarterly",
//     },
//     {
//       title: "GATE Preparation",
//       description:
//         "Comprehensive coaching and mock tests for GATE ECE examination",
//       frequency: "Year-round",
//     },
//     {
//       title: "Industry Visits",
//       description:
//         "Exposure to real-world electronics manufacturing and R&D facilities",
//       frequency: "Semester",
//     },
//     {
//       title: "Research Papers",
//       description:
//         "Supporting students in publishing research in electronics journals",
//       frequency: "Ongoing",
//     },
//   ];
...
//             innovation, collaboration, and hands-on learning experiences.
//           </p>
//         </div>
...
//               }`}
//             >
//               To create a vibrant community of electronics enthusiasts who push
//               the boundaries of technology through collaborative learning,
//               innovative projects, and industry engagement. We aim to bridge the
//               gap between academic knowledge and practical application in the
//               field of electronics and communication engineering.
//             </p>
//           </div>
...
//               }`}
//             >
//               To be the premier electronics club that nurtures future technology
//               leaders, fosters innovation in VLSI design and embedded systems,
//               and contributes significantly to the advancement of electronics
//               engineering through research, development, and knowledge sharing.
//             </p>
//           </div>
//         </div>
...
//           >
//             <p className="text-lg leading-relaxed mb-4">
//               Founded in 2022 by a group of passionate electronics engineering
//               students, Nano-Nerds began as a small study group focused on VLSI
//               design and embedded systems. What started with just 25 members has
//               now grown into a thriving community of over 150 active
//               participants from various engineering disciplines.
//             </p>
//             <p className="text-lg leading-relaxed mb-4">
//               Our club emerged from the recognition that traditional classroom
//               learning, while fundamental, often lacks the practical, hands-on
//               experience that today's technology industry demands. We set out to
//               create a space where students could experiment, innovate, and
//               collaborate on real-world projects that would prepare them for
//               successful careers in electronics and technology.
//             </p>
//             <p className="text-lg leading-relaxed">
//               Today, we are proud to be recognized as one of the leading student
//               organizations in our institution, with alumni working at top
//               technology companies worldwide and continuing to contribute to the
//               electronics engineering field through research and innovation.
//             </p>
//           </div>
//         </section>
...
//               electronics engineering. Your journey towards innovation starts
//               here.
//             </p>
//             <div className="flex flex-col sm:flex-row gap-4 justify-center">
//               <button className="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300 flex items-center justify-center">
  ...
  const values = [
    {
      ...
      title: "Curiosity",
      description:
        "Encouraging students to explore electronics concepts beyond textbooks.",
    },
    {
      icon: Users,
      title: "Collaboration",
      description:
        "Learning together through teamwork, peer guidance, and discussions.",
    },
    {
      icon: BookOpen,
      title: "Practical Learning",
      description:
        "Applying theoretical knowledge through hands-on projects and sessions.",
    },
    {
      icon: Target,
      title: "Consistency",
      description:
        "Regular practice and participation to build strong fundamentals.",
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-6">
            <Zap className="h-14 w-14 text-blue-600" />
          </div>
          <h1
            className={`text-4xl md:text-5xl font-bold mb-6 ${
              darkMode ? "text-white" : "text-gray-900"
          ...
          >
            Nano-Nerds is a student-led electronics club focused on learning,
            building, and growing together through practical experiences.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p
              className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}
            >
              To provide a platform where students can explore electronics,
              improve their technical skills, and gain hands-on experience
          ...
          >
            ...
            <p
              className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}
            >
              To build a supportive learning community that helps students
              develop a strong foundation in electronics and prepares them for
              future academic and industry opportunities.
            </p>
          </div>
        </div>
