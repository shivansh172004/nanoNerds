        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 lg:col-span-2">
              ...
              >
                ...
                design, embedded systems, and hardware development. Join us to
                explore the cutting-edge world of electronics engineering.
              </p>
              ...
              <ul className="space-y-2">
                {quickLinks.map((link) => (
                  <li key={link.path}>
                    <Link
                      to={link.path}
                      className={`text-sm transition-colors duration-200 hover:text-orange-600 ${
                        darkMode
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              ...
              >
                © {new Date().getFullYear()} Nano-Nerds Electronics Club. All
                rights reserved.
              </p>
            </div>
          </div>
